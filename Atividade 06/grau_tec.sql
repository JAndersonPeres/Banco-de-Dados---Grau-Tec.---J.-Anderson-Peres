...
-- Aula 06
INSERT INTO aluno(cpf,nome,data_nascimento) VALUES
('111222333-44','Ana Silva','2002-05-14'),
('222333444-55','Bruno Santos','2001-09-22'),
('333444555-66','Carla Oliveira','2003-01-10'),
('444555666-77','Diego Pereira','2000-12-03');

INSERT INTO professor(nome,formacao,idade) VALUES
('Marcos Lima','Engenharia de Software',40),
('Fernanda Costa','Ciência da Computação',35),
('João Almeida','Sistema de Informação',45);

INSERT INTO curso(nome_curso,duracao) VALUES
('Análise e Desenvolvimento de Sistema', 3),
('Ciência da Computação',4),
('Engenharia de Software',4);

INSERT INTO materia(nome,id_curso,id_professor,carga_horaria) VALUES
('Banco de Dados',4,4,80),
('Programação Orientada a Objetos',4,5,80),
('Estrutura de Dados',5,5,60),
('Engenharia de Requisitos',3,3,60);
